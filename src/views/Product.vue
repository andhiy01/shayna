                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="product-thumbs">
                                    <carousel class="product-thumbs-track ps-slider" :nav='false' :dots='false' :autoplay='false'>
                                        <div class="pt mr-1" @click="changeImage(thumbs[0])" :class="thumbs[0] == gambar_default ? 'active' : '' ">
                                            <img src="img/mickey1.jpg" alt="" />
                                        </div>

                                        <div class="pt mr-1" @click="changeImage(thumbs[1])" :class="thumbs[1] == gambar_default ? 'active' : '' ">
                                            <img src="img/mickey2.jpg" alt="" />
                                        </div>

                                        <div class="pt mr-1" @click="changeImage(thumbs[2])" :class="thumbs[2] == gambar_default ? 'active' : '' ">
                                            <img src="img/mickey3.jpg" alt="" />
                                        </div>

                                        <div class="pt mr-1" @click="changeImage(thumbs[3])" :class="thumbs[3] == gambar_default ? 'active' : '' ">
